...
# ІМПОРТ ALLAUTH ДЛЯ БЕЗПЕЧНОЇ АВТОРИЗАЦІЇ
...
urlpatterns = [
    ...
    path('practice/<int:material_id>/', practice_session_view, name='practice_session'),
    ...
    path('attempt/<int:attempt_id>/', views.view_attempt_details, name='view_attempt_details'),
]
