...
class Command(BaseCommand):
    help = 'Автоматичне наповнення бази даних діагностичним тестом НМТ (22 питання із точними назвами тем)'

    def handle(self, *args, **kwargs):
        self.stdout.write("Починаємо генерацію тесту (точні назви матеріалів)...")

        # Очищаємо базу від старих питань та старих загальних тем
        Question.objects.all().delete()
        DiagnosticTopic.objects.all().delete()

        # 1. Створюємо теми (ТОЧНІ НАЗВИ ВАШИХ PDF ФАЙЛІВ)
        topics_data = [
            "6. Лінійні рівняння. Лінійні рівняння з параметром",
            "2. Відношення, пропорції та відсотки",
            "31. Трикутники",
            "20. Логарифмічні вирази",
            "5. Розкладання на множники. Дробово-раціональні вирази",
            "11. Функції та їх властивості",
            "24. Побудова графіків функцій шляхом перетворень",
            "16. Системи нерівностей",
            "36. Чотирикутники",
            "25. Числові послідовності",
            "29. Початки теорії ймовірностей та елементи статистики",
            "46. Вектори на площині та у просторі",
            "39. Вступ до стереометрії",
            "15. Системи рівнянь",
            "26. Похідна",
            "3. Степені",
            "33. Прямокутний трикутник",
            "27. Первісна та інтеграл",
            "40. Призма",
        ...
        questions_data = [
            ...
            (r"Розв’яжіть рівняння $\frac{3x}{4} = 6$.", topics["6. Лінійні рівняння. Лінійні рівняння з параметром"], 'CHOICE', None,
            ...
            topics["2. Відношення, пропорції та відсотки"], 'CHOICE', None,
            ...
            topics["31. Трикутники"], 'CHOICE', None,
            [(r"$10^\circ$", False), (r"$20^\circ$", True), (r"$30^\circ$", False), (r"$40^\circ$", False), (r"$50^\circ$", False)], None),

            (r"Обчисліть значення виразу $\log_2 24 - \log_2 3$.", topics["20. Логарифмічні вирази"], 'CHOICE', None,
             [("3", True), ("4", False), ("8", False), (r"$\log_2 21$", False), ("21", False)], None),

            (r"Спростіть вираз $\frac{x^2 - 16}{x^2 - 4x}$.", topics["5. Розкладання на множники. Дробово-раціональні вирази"], 'CHOICE', None,
             [(r"$\frac{x-4}{x}$", False), (r"$\frac{x+4}{x}$", True), (r"$\frac{4}{x}$", False), ("x+4", False), ("x-4", False)], None),

            (r"Знайдіть область визначення функції $y = \sqrt{6 - 2x}$.", topics["11. Функції та їх властивості"], 'CHOICE', None,
             [(r"$[3; +\infty)$", False), (r"$(-\infty; 3]$", True), (r"$[-3; +\infty)$", False), (r"$(-\infty; -3]$", False), (r"$(-\infty; +\infty)$", False)], None),

            (r"Графік функції $y = f(x)$ проходить через точку $M(2; -4)$. Через яку точку обов'язково проходить графік функції $y = f(x - 1) + 3$?",
            topics["24. Побудова графіків функцій шляхом перетворень"], 'CHOICE', None,
            ...
            topics["16. Системи нерівностей"], 'CHOICE', None,
            ...
            topics["36. Чотирикутники"], 'CHOICE', None,
            [("лише I", False), ("лише II", False), ("лише III", True), ("лише I та III", False), ("I, II та III", False)], None),

            (r"У геометричній прогресії $(b_n)$ задано $b_1 = 3$ і знаменник $q = -2$. Знайдіть четвертий член $b_4$ цієї прогресії.",
            topics["25. Числові послідовності"], 'CHOICE', None,
            ...
            (r"На тарілці лежать 5 яблук і 7 груш. Яка ймовірність того, що навмання взятий фрукт виявиться яблуком?",
             topics["29. Початки теорії ймовірностей та елементи статистики"], 'CHOICE', None,
             [(r"$\frac{5}{7}$", False), (r"$\frac{7}{12}$", True), (r"$\frac{5}{12}$", False), (r"$\frac{1}{5}$", False), (r"$\frac{1}{12}$", False)], None),

            (r"Задано вектори $\vec{a}(2; -1; 3)$ та $\vec{b}(m; 2; -2)$. За якого значення $m$ ці вектори є перпендикулярними?",
            topics["46. Вектори на площині та у просторі"], 'CHOICE', None,
            ...
            topics["39. Вступ до стереометрії"], 'CHOICE', None,
            [("1 см", False), ("5 см", True), (r"$\sqrt{313}$ см", False), ("25 см", False), (r"$\sqrt{119}$ см", False)], None),

            (r"Відомо, що $\begin{cases} x - y = 4 \\ x^2 - y^2 = 20 \end{cases}$. Знайдіть значення виразу $x + y$.",
             topics["15. Системи рівнянь"], 'CHOICE', None,
             [("5", True), ("16", False), ("24", False), ("80", False), ("Неможливо визначити", False)], None),

            (r"Обчисліть значення похідної функції $f(x) = x^3 - 4x$ у точці $x_0 = 2$.",
             topics["26. Похідна"], 'CHOICE', None,
             [("0", False), ("4", False), ("8", True), ("12", False), ("24", False)], None),

            # --- ЧАСТИНА 2: ВІДПОВІДНОСТІ (16-18) монолітні ---
            (r"Установіть відповідність між функцією (1–3) та її властивістю (А–Д).",
             topics["11. Функції та їх властивості"], 'MATCH', None,
            ...
            topics["33. Прямокутний трикутник"], 'MATCH', None,
            [(r"А. $6\sqrt{3}$ см", False), ("Б. 12 см", False), (r"В. $3\sqrt{3}$ см", False), ("Г. 6 см", False), ("Д. 18 см", False)],
            ...
            topics["2. Відношення, пропорції та відсотки"], 'SHORT', "10200", [], None),

            (r"Обчисліть інтеграл $\int_1^2 (6x^2) dx$.",
             topics["27. Первісна та інтеграл"], 'SHORT', "14", [], None),
            ...
            topics["40. Призма"], 'SHORT', "240", [], None),

            (r"Визначте найбільший корінь рівняння $(x^2 - 4x - 5)\sqrt{x - 2} = 0$.",
             topics["10. Ірраціональні рівняння"], 'SHORT', "5", [], None),
        ]
        ...
        self.stdout.write(self.style.SUCCESS("✅ Успіх! 22 завдання з точними назвами файлів завантажено."))