...
class Question(models.Model):
    ...
    image = models.ImageField(upload_to='diagnostic_questions/', blank=True, null=True, verbose_name="Картинка (якщо є)")
    correct_short_answer = models.CharField(max_length=50, blank=True, null=True, verbose_name="Відповідь (тільки для 19-22 завдань)")
...
class MatchItem(models.Model):
    ...
    question = models.ForeignKey(Question, on_delete=models.CASCADE, related_name='match_items', verbose_name="Завдання")
